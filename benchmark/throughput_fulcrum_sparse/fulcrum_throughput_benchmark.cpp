...
BENCHMARK_OPTION(throughput_options)
{
   ...
   density.push_back(0.6);
   density.push_back(0.7);
   density.push_back(0.8);
   density.push_back(0.9);
...
BENCHMARK_F(setup_fulcrum_inner_throughput, FulcrumInner, Binary, 100);
...
BENCHMARK_F(setup_fulcrum_outer_throughput, FulcrumOuter, Binary8, 100);
...
BENCHMARK_F(setup_fulcrum_combined_throughput, FulcrumCombined, Binary8, 100);
